        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="text-4xl font-bold text-gray-900 sm:text-5xl md:text-6xl">
              Welcome to{' '}
              <span className="text-primary-600">Thyme</span>
            </h1>
            <p className="mt-6 text-xl text-gray-600 max-w-3xl mx-auto">
              A modern task management app built with TrailBase. Organize your time, 
              track your progress, and achieve your goals with our intuitive interface.
            </p>
      ...
      <div className="bg-primary-600 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-primary-100 mb-8">
            Join thousands of users who trust Thyme for their task management needs.
          </p>
          {!user && (
            <Link
              to="/register"
